...
| اعتماد وعقد وملكية غير قابلة للمقارنة | خرائط كاملة لـ19 حزمة و97 حافة و97 سجل عقد و40 جدولًا | `docs/architecture/*.json` | `--group package` | مغلقة |
